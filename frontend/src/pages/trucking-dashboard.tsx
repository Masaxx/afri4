...
export default function TruckingDashboard() {
  ...
  return (
    <div
      ...
      data-testid="trucking-dashboard"
    >
      <Navbar />
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} data-testid="dashboard-tabs">
          <TabsList className="grid w-full grid-cols-4">
            <TabsTrigger value="jobs" className="flex items-center gap-2" data-testid="tab-jobs">
              <Search className="h-4 w-4" /> Available Jobs
            </TabsTrigger>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold flex items-center gap-2">
                    <Filter className="h-5 w-5" /> Filter Jobs
                  </h3>
                  <Button
                    variant="outline"
                    size="sm"
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <Select
                    onValueChange={(value) =>
                      handleFilterChange("pickupCountry", value)
                    }
                  ...
                  <Select
                    onValueChange={(value) =>
                      handleFilterChange("cargoType", value)
                    }
